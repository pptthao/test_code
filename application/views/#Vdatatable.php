                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody class="" id="dsmon">
                                            ...
                                            <tr class="test">
                                                ...
                                                <td>{$val['masv']}</td>
                                                <td>{$val['tensv']}</td>
                                                <td><button type='button' value="{$val['id']}" name='sua' class="btn btn-primary btnSua {$val['id']}" data-toggle='modal' data-target='#modaledit' id="{$val['id']}">Sửa</button>&emsp;<button type='button' value="{$val['id']}" name='xoa' class='btn btn-danger btnXoa' id='' onclick= 'xacnhanxoa()'>Xóa</button></td></td>
                                            </tr>
                                            {/foreach}
                                            {/if}
                                        </tbody>
